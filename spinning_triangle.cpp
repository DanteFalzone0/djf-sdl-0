...
int main() {
    ...
    main_window = SDL_CreateWindow(
        "Spinning Triangle - Coded in C++ by Dante Falzone",
    ...
    while (window_open) {
        ...
        angle_0 = rotate_point(300, 300, 0.001, angle_0);
        angle_1 = rotate_point(300, 300, 0.001, angle_1);
        angle_2 = rotate_point(300, 300, 0.001, angle_2);
